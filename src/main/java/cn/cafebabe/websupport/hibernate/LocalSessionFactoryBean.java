 ...
 * @created 14-4-11
 */
public class LocalSessionFactoryBean extends org.springframework.orm.hibernate4.HibernateExceptionTranslator
		implements FactoryBean<SessionFactory>, ResourceLoaderAware, InitializingBean, DisposableBean
{
	...
	private org.hibernate.cache.spi.RegionFactory cacheRegionFactory;
	...
	private Class<? extends BasicType>[] customTypes = null;
	 ...
	 */
	public void setCacheRegionFactory(org.hibernate.cache.spi.RegionFactory cacheRegionFactory)
	{
	...
	public void afterPropertiesSet() throws IOException
	{
		...
		if (customTypes != null)
		{
			for (Class<? extends BasicType> costumType : customTypes)
			{
				try
				{
					BasicType type = costumType.newInstance();
					sfb.registerTypeOverride(type);
				}
				catch (Exception e)
				{
					throw new RuntimeException(costumType + "不能实例化", e);
				}
			}
		}
	...
	public void setCustomTypes(Class<? extends BasicType>[] customTypes)
	{
